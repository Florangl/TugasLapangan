    ...
    <div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between px-4">
                        ...
                        <button type="button"
                            ...
                            <span class="sr-only">Menu Tutup</span>
                    ...
                    <form class="mt-4 border-t border-gray-200">
                        ...
                        <ul role="list" class="px-2 py-3 font-medium text-gray-900">
                            <li>
                                <a href="#" class="block px-2 py-3">Keranjang</a>
                            </li>
                            <li>
                                <a href="#" class="block px-2 py-3">Ransel</a>
                            </li>
                            <li>
                                <a href="#" class="block px-2 py-3">Tas Travel</a>
                            </li>
                            <li>
                                <a href="#" class="block px-2 py-3">Tas</a>
                            </li>
                            <li>
                                <a href="#" class="block px-2 py-3">Barang</a>
                            </li>
                        </ul>
                                ...
                                <div class="space-y-6">
                                    <div class="flex items-center">
                                        ...
                                        <label for="filter-mobile-color-0"
                                               class="ml-3 min-w-0 flex-1 text-gray-500">Putih</label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="filter-mobile-color-1"
                                               class="ml-3 min-w-0 flex-1 text-gray-500">Krem</label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="filter-mobile-color-2"
                                               class="ml-3 min-w-0 flex-1 text-gray-500">Biru</label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="filter-mobile-color-3"
                                               class="ml-3 min-w-0 flex-1 text-gray-500">Cokelat</label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="filter-mobile-color-4"
                                               class="ml-3 min-w-0 flex-1 text-gray-500">Hijau</label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="filter-mobile-color-5"
                                               class="ml-3 min-w-0 flex-1 text-gray-500">Ungu</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="space-y-6">
                                    <div class="flex items-center">
                                        ...
                                        <label for="filter-mobile-category-0"
                                               class="ml-3 min-w-0 flex-1 text-gray-500">Pendatang Baru</label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="filter-mobile-category-1"
                                               class="ml-3 min-w-0 flex-1 text-gray-500">Penjualan</label>
                                    </div>
                                    <div class="flex items-center">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="filter-mobile-category-3"
                                               class="ml-3 min-w-0 flex-1 text-gray-500">Organisasi</label>
                                    </div>
                                    <div class="flex items-center">
                                        ...
                                        <label for="filter-mobile-category-4"
                                               class="ml-3 min-w-0 flex-1 text-gray-500">Aksesoris</label>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-10">
                <h1 class="text-4xl font-bold tracking-tight text-green-500">Layanan</h1>
                ...
                <div class="flex items-center">
                    ...
                    <button type="button" class="-m-2 ml-5 p-2 text-gray-400 hover:text-gray-500 sm:ml-7">
                        <span class="sr-only">Lihat grid</span>
            ...
            <section aria-labelledby="products-heading" class="pb-24 pt-6">
                <h2 id="products-heading" class="sr-only">Layanan</h2>
