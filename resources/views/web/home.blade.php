...
<section
class="relative bg-cover bg-center bg-no-repeat " style="background-image: url({{ asset('images/lapanganku.jpg') }}" ;>
...
>
  <div class="max-w-xl text-left ltr:sm:text-left rtl:sm:text-right">
    <h1 class="text-3xl font-extrabold sm:text-5xl text-neutral-700">
      Temukan Pengalaman Pelatihan Olahraga Sempurna Anda di
      <strong class="block font-extrabold text-green-500">
        Lapangan Badminton Field.      </strong>
    </h1>

    <p class="mt-4 max-w-lg sm:text-xl/relaxed">
      Temukan Dunia olahraga dengan pemesanan lapangan Bulutangkis.
         </p>
...
<a
 ...
 <div>
    <div class="text-center text-4xl font-semibold text-green-500 m-2 mt-5">Kategori</div>
    ...
    <div class="container flex gap-10 p-10 pt-3 justify-center mx-auto">
      <a href="#" class="text-center gap-2 duration-300 hover:scale-105">
          <img class="w-60 rounded-xl" src="{{ asset('images/lapangan.jpg')}}" alt="">
          <span class="text-green-500 text-2xl">Lapangan</span>
      </a>
      <a href="#" class="text-center gap-2 duration-300 hover:scale-105">
        <img class="w-60 rounded-xl" src="{{ asset('images/bola.png')}}"  alt="">
        <span class="text-green-500 text-2xl">Bola</span>

      </a>
      <a href="#" class="text-center gap-2 duration-300 hover:scale-105">
        <img class="w-60 rounded-xl" src="{{ asset('images/duduk.jpg')}}" alt="">
        <span class="text-green-500 text-2xl">Tempat Duduk</span>

      </a>
      <a href="#" class="text-center gap-2 duration-300 hover:scale-105">
        <img class="w-60 rounded-xl" src="{{ asset('images/istirahat.jpeg')}}" alt="">
        <span class="text-green-500 text-2xl">Istirahat</span>
      </a>
    </div>
    ...
    <section class="pt-5 bg-white">
      <div class="md:w-4/5 mx-auto">
        <div class="mx-auto text-center md:max-w-xl lg:max-w-3xl">
          <h3 class="mb-6 text-3xl text-green-500 font-bold">Layaran Popular</h3>
          <p class="mb-6 pb-2 text-gray-700 md:mb-12 md:pb-0">
            Layanan Populer di kalangan pelanggan kami.
          </p>
        </div>
      ...
      <div class="flex justify-end mx-auto Field CleaningField Cleaningb-5 gap-3 md:w-3/4">
...
<div>
  <div class="text-center text-4xl font-semibold text-green-500 m-2">penawaran</div>
</div>
<div class="flex gap-10 ">
    ...
    <section class="pt-5 pb-5">
        <div class="mx-auto text-center md:max-w-xl lg:max-w-3xl">
          <h3 class="text-3xl text-green-500 font-bold">Galeri</h3>
        </div>
  ...
  <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
    ...
    <div>
      ...
      <p class="mb-4 flex items-center justify-center md:justify-start">
        ...
        info --> @LagubotiBadmintonfield.com
      </p>
      <p class="mb-4 flex items-center justify-center md:justify-start">
        <svg
          xmlns="http://www.w3.org/2000/svg"
...
<div class="bg-white p-2 text-center">
  <span class="text-neutral-500">©lapangan 2023 Copyright:</span>
  <a
